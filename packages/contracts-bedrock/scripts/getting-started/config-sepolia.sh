...
config=$(cat << EOL
{
  ...
  "batchInboxAddress": "0xff00000000000000000000000000000000032001",
  ...
  "governanceTokenSymbol": "W3G",
  "governanceTokenName": "W3Gamez Network",
...
echo "$config" > deploy-config/w3gamez-sepolia.json
